...
public class BackgroundImage implements Parcelable {
    public static final Creator<BackgroundImage> CREATOR = new Creator<BackgroundImage>() { // from class: com.chettapps.invitationmaker.photomaker.pojoClass.BackgroundImage.1
