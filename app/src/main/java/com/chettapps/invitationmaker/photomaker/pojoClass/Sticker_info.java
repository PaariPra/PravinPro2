...
public class Sticker_info implements Parcelable {
    public static final Creator<Sticker_info> CREATOR = new Creator<Sticker_info>() { // from class: com.chettapps.invitationmaker.photomaker.pojoClass.Sticker_info.1
