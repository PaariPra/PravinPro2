...
public class StickerCategoryListAdapter extends RecyclerView.Adapter<StickerCategoryListAdapter.ViewHolder> {
    ...
    public StickerCategoryListAdapter(Activity activity, String[] strArr, int[] iArr, int[] iArr2) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, @SuppressLint("RecyclerView") final int i) {
        ...
        viewHolder.layout.setOnClickListener(new View.OnClickListener() { // from class: com.chettapps.invitationmaker.photomaker.adapter.StickerCategoryListAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                StickerCategoryListAdapter.this.mSingleCallback.onClickCallBack(null, String.valueOf(i), StickerCategoryListAdapter.this.context,"" );
                StickerCategoryListAdapter stickerCategoryListAdapter = StickerCategoryListAdapter.this;
                stickerCategoryListAdapter.notifyItemChanged(stickerCategoryListAdapter.selected_position);
                StickerCategoryListAdapter.this.selected_position = i;
                StickerCategoryListAdapter stickerCategoryListAdapter2 = StickerCategoryListAdapter.this;
                stickerCategoryListAdapter2.notifyItemChanged(stickerCategoryListAdapter2.selected_position);
            }
        });
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            StickerCategoryListAdapter.this.setMyFontNormal((ViewGroup) view.findViewById(R.id.main));
        }
    }
}
